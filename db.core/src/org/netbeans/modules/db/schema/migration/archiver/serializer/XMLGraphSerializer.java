...
package org.netbeans.modules.db.schema.migration.archiver.serializer;
        ...
        try
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    this.addAttribute(classAttrib, org.netbeans.modules.db.schema.migration.archiver.MapClassName.getClassNameToken( lClassType.getName()), lClassAttributes);
...
//                            lFields.add(lTFields[i]);    
    ...
    private void xlateArray(String name, Object obj) throws IOException, IllegalAccessException
    {
        ...
        this.addAttribute(rowClassAttrib,org.netbeans.modules.db.schema.migration.archiver.MapClassName.getClassNameToken( obj.getClass().getComponentType().getName()), lArrayAttributes);
...
//        System.out.println( "Class Type is " + obj.getClass().getName() );
    ...
    private void xlateSimpleRow(int rowNumber, Object obj) throws IOException
    {
        ...
        if ( lObjectClass.isPrimitive() )
        {
            ...
            this.addAttribute("ROWCLASS",  org.netbeans.modules.db.schema.migration.archiver.MapClassName.getClassNameToken( lObjectClass.getName()) , lRowAttributes);
