...
public class SchemaRootChildren extends Children.Keys {
  ...
  * be kept to prevent the listener from finalizing when we are alive */
  ...
  private org.netbeans.modules.db.schema.jdbcimpl.DBschemaDataObject obj;
  ...
  */
  public SchemaRootChildren(final DBElementNodeFactory factory, org.netbeans.modules.db.schema.jdbcimpl.DBschemaDataObject obj) {
    super();
