...
package org.netbeans.lib.lexer.internal.token;

import org.netbeans.lib.lexer.TokenId;
import org.netbeans.lib.lexer.internal.StackElementArray;
import org.netbeans.lib.lexer.internal.TokenHierarchyOperation;
import org.netbeans.lib.lexer.internal.TokenList;
import org.netbeans.lib.lexer.internal.WrapTokenId;
import org.netbeans.util.CharSequenceUtilities;
                        ...
                        (inputSource = op.inputSource()) != null)
                {
                    ...
                    if (inputSource instanceof Document) {
                        ...
                        sb.append("  document-locked: "). // NOI18N
                                append(DocumentUtilities.isReadLocked(doc));
                    }
                    sb.append('\n');
                }
