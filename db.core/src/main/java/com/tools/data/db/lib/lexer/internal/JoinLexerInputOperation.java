...
import com.tools.data.db.lib.lexer.LexerInput;
import com.tools.data.db.lib.lexer.PartType;
import com.tools.data.db.lib.lexer.TokenId;
import com.tools.data.db.lib.lexer.TokenPropertyProvider;
 ...
 * {@link #activeTokenList()} and also special { #JoinToken} instances
...
public class JoinLexerInputOperation<T extends TokenId> extends LexerInputOperation<T> {
    ...
    final class TokenListText {
         ...
         * 
         * @param offset index in the same metrics as readIndex.
