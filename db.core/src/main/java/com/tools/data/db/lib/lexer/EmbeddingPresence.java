...
public enum EmbeddingPresence {
    ...
    /**
     * Creation of the default embedding for the particular { org.netbeans.api.lexer.TokenId}
    ...
    /**
     * There is no default embedding for the given { org.netbeans.api.lexer.TokenId}
