...
public class CompactMap<K,V> implements Map<K,V> {
     ...
     * data type.
     */
    public static abstract class MapEntry<K,V> implements Entry<K,V> {
        ...
        /**
         * Implementation that adheres to {@link Entry#hashCode()} contract.
         */
        @Override
        ...
        /**
         * Implementation that adheres to {@link Entry#equals(Object)} contract.
         */
        @Override
