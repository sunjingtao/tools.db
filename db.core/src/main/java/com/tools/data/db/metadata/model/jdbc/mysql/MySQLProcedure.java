...
package com.tools.data.db.metadata.model.jdbc.mysql;

import java.sql.ResultSet;
import java.sql.SQLException;

import com.tools.data.db.metadata.model.api.MetadataElement;
import com.tools.data.db.metadata.model.api.Nullable;
import com.tools.data.db.metadata.model.api.Parameter;
import com.tools.data.db.metadata.model.api.SQLType;
import com.tools.data.db.metadata.model.jdbc.JDBCParameter;
import com.tools.data.db.metadata.model.jdbc.JDBCProcedure;
import com.tools.data.db.metadata.model.jdbc.JDBCSchema;
import com.tools.data.db.metadata.model.jdbc.JDBCUtils;
import com.tools.data.db.metadata.model.jdbc.JDBCValue;
