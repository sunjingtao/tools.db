...
import com.tools.data.db.lib.lexer.MutableTextInput;
import com.tools.data.db.lib.lexer.internal.LanguageManager;
import com.tools.data.db.lib.lexer.internal.LexerApiPackageAccessor;
import com.tools.data.db.lib.lexer.internal.TokenHierarchyOperation;
import com.tools.data.db.util.DocumentUtilities;
 ...
 * must be initialized by using { #init(Document, boolean, Object)}.
 *
